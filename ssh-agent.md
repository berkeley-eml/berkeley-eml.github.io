...
SSH agent forwarding allows you to use the [SSH keys](ssh-keys.md) stored on your local device to authenticate to remote systems, without copying the private keys between machines. This is especially useful when connecting to multiple accounts on an HPC cluster, such as your personal Unix account and shared project accounts.
